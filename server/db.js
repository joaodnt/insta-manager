...
if (store.posts.length === 0) {
  ...
  const POSTS = [
    ...
    { day: 31, pilar: 'noticias',    formato: 'carrossel', hook: 'OpenAI acabou de lançar algo que muda tudo para infoprodutores.', caption: 'A cada semana uma novidade de IA que impacta diretamente o mercado digital.\n\nSiga para ficar por dentro antes de todo mundo.\n\n#noticias #IA #openai #infoproduto #mercadodigital', image_prompt: 'Breaking news style design, AI technology announcement, bold headline on dark background 1:1' },
    { day: 32, pilar: 'noticias',    formato: 'reel',      hook: 'Google acaba de matar uma das maiores ferramentas de IA do mercado.', caption: 'E agora? O que usar no lugar?\n\nAnalisei as 3 melhores alternativas.\n\nSalva esse Reel.\n\n#noticias #google #IA #ferramentas #infoproduto', image_prompt: 'Google logo with dramatic news effect, breaking tech news, dark cinematic 9:16' },
    { day: 33, pilar: 'noticias',    formato: 'carrossel', hook: 'Nova lei pode proibir IA no marketing digital no Brasil. Entenda.', caption: 'Regulamentacao de IA esta chegando. Se voce usa IA no seu negocio, precisa saber disso.\n\nSalva e manda pra quem precisa ver.\n\n#noticias #regulamentacao #IA #marketingdigital #brasil', image_prompt: 'Brazilian law and AI regulation concept, gavel with AI circuit board, serious professional 1:1' },
    { day: 34, pilar: 'noticias',    formato: 'single',    hook: 'Meta anuncia ferramenta de IA que cria anuncios sozinha. O jogo mudou.', caption: 'A Meta lancou uma IA que cria criativos, escreve copy e otimiza campanha.\n\nIsso muda completamente o jogo para quem faz trafego pago.\n\nComente: voce usaria?\n\n#noticias #meta #IA #trafegopago #anuncios', image_prompt: 'Meta AI advertisement creation concept, futuristic marketing automation, bold tech design 1:1' },
  ];
